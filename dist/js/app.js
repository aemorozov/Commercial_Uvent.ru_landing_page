      ...
      function (e, t, r) {
        ...
        for (let t = 0; t < n.length; t++) {
          ...
          for (let e = 0; e < u; e++)
            (n[
              t
            ].innerHTML += `<span class="opacity-0-styling" id="${o}${i}">${l[e]}</span>`),
              i++;
        }
        i = 0;
        {
          const s = setInterval(() => {
            var e = document.querySelector("#" + o + i);
            e ? (e.classList.add("opacity-1-styling"), i++) : clearInterval(s);
          }, 100);
        }
      },
      {},
